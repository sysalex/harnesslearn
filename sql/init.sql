...
CREATE TABLE `department` (
  ...
  `created_by_user_id` BIGINT DEFAULT NULL COMMENT '创建人 ID',
  `created_by_user_name` VARCHAR(50) DEFAULT NULL COMMENT '创建人名称',
  `created_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_by_user_id` BIGINT DEFAULT NULL COMMENT '更新人 ID',
  `updated_by_user_name` VARCHAR(50) DEFAULT NULL COMMENT '更新人名称',
...
CREATE TABLE `makeup_application` (
  ...
  `approval_comment` TEXT DEFAULT NULL COMMENT '审批意见',
  `approved_at` DATETIME DEFAULT NULL COMMENT '审批时间',
  `createdByUserId` BIGINT DEFAULT NULL COMMENT '创建人 ID',
  `createdByUserName` VARCHAR(50) DEFAULT NULL COMMENT '创建人名称',
  `createdTime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedByUserId` BIGINT DEFAULT NULL COMMENT '更新人 ID',
  `updatedByUserName` VARCHAR(50) DEFAULT NULL COMMENT '更新人名称',
  `updatedTime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `enabledFlag` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '是否启用',
  `deletedFlag` TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`),
  KEY `idx_user_status` (`user_id`, `status`),
  KEY `idx_approver_status` (`approver_id`, `status`),
...
INSERT INTO `user` (
  ...
  `created_by_user_id`, `created_by_user_name`, `updated_by_user_id`, `updated_by_user_name`, `enabled_flag`, `deleted_flag`
) VALUES
